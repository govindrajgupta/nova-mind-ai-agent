...
function DashboardPage () {
  ...
  <div className="flex-1 flex items-center justify-center p-4">
    ...
    <div className="relative space-y-6 p-8 text-center">
      <div className="bg-white/60 backdrop-blur-sm shadow-sm ring-1 ring-gray-200/50 rounded-2xl p-7 space-y-4">
      <div className="bg-gradient-to-b from-gray-50 to-white rounded-xl p-4 inline-flex">
        <BotIcon className="w-24 h-24 text-gray-600"/>

      </div>
      <h2 className="text-2xl font-semibold bg-gradient-to-br text-gray-900 to-gray-600 bg-clip-text">Welcome to AI Agent Assistant! 🚀

      </h2>
      <p className="text-gray-600 max-w-md mx-auto">
        Start a new conversation or select an existing chat from the sidebar. Your AI Agent is ready to assist you with any task or question you have. 🤖
